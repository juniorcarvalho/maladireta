"""
Django settings for casaditalia project.
...
INSTALLED_APPS = [
    ...
    'casaditalia.financeiro.apps.FinanceiroConfig',
    'suit',
...
WSGI_APPLICATION = 'casaditalia.wsgi.application'
